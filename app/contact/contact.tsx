      ...
      <section className="relative bg-gradient-to-r from-primary/5 to-accent/5 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
            ...
            help you find the perfect purification solution for your home.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground text-lg mb-8">
                  At PureLife, we're committed to providing exceptional customer
                  service and support. Whether you need product information,
                  technical assistance, or have questions about your order, our
              ...
              <div className="bg-muted/30 rounded-lg p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  For urgent technical support or product issues, please call
                  our dedicated support line. Our technical experts are
                  available to help you troubleshoot and resolve any problems
                  quickly.
                </p>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        All products come with a 2-year comprehensive warranty
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Yes, we provide professional installation services in
                        most areas. Contact us for availability.
                      </p>
                    </div>
                  </div>
                </CardContent>
