...
export default function ProductsPage() {
  ...
  const getPageDescription = () => {
    if (category === "water-purifier") return "Advanced water filtration systems for pure, clean drinking water"
    if (category === "air-purifier") return "HEPA air purifiers for cleaner, fresher indoor air quality"
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-center gap-2">
              {category && (
                <Badge variant="secondary">{category === "water-purifier" ? "Water Purifiers" : "Air Purifiers"}</Badge>
              )}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Button
                        variant={category === "water-purifier" ? "default" : "ghost"}
                        size="sm"
                        className="w-full justify-start"
                        onClick={() => (window.location.href = "/products?category=water-purifier")}
                      >
                        Water Purifiers
                      </Button>
                      <Button
                        variant={category === "air-purifier" ? "default" : "ghost"}
                        size="sm"
                        className="w-full justify-start"
                        onClick={() => (window.location.href = "/products?category=air-purifier")}
                      >
                        Air Purifiers
                      </Button>
                    </div>
